---
title: "Případová studie: Locika – Digitalizace jako impuls pro efektivitu a rozvoj"
author: jakub.holzer
...
### Jak začala digitalizace v Locice: Řešené problémy a přístup

Digitalizace v organizaci dlouho nebyla vnímána jako priorita, pokud se na ni netlačilo zvenčí. Impuls přišel díky kurz Nezisk.Digital, který znamenal jasný začátek změny – i když byl časově náročný, přinesl konkrétní rámec a motivaci. Zároveň pomohl ujasnit hlavní cíl digitalizace a to, že má snižovat manuální práci a uvolňovat kapacitu pro přímou práci s klienty. Na poradě širšího vedení bylo vytyčeno několik oblastí, kde digitalizace nejvíc „pálí“:

• **Evidence financí a projektové řízení:** Organizace měla potíže s efektivní evidencí financí a ručním přepisováním dat z účetního softwaru Pohoda do Excelu.

• **Projektová komunikace:** Nedostatek jednotného a efektivního komunikačního nástroje pro řízení projektů.

• **Správa dárců (CRM):** Organizace neměla pod kontrolou velké množství malých dárců a chyběl jí systém pro efektivní komunikaci s nimi.

• **Vnitřní efektivita:** Potřeba zefektivnit práci týmu, snížit manuální úkony a umožnit pracovníkům soustředit se více na klienty.

### Jak k tomu v Locice přistoupili
